...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.8\textwidth]{Figures/concurent.png}
		\rule{35em}{0.2pt}s
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.57\textwidth]{Figures/gpuOptimization.png}
		\rule{35em}{0.2pt}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.62\textwidth]{Figures/speed.png}
		\rule{35em}{0.2pt}
