...
Spintronics is a new type of electronics that exploits the spin degree of freedom of an electron in addition to its charge. It is expected that electronics technology and devices will be faster, compacter and more engery-saving \cite{spinz}
