...
An abrupt in magnetization at the boundary of two anti-aligned domains is not a favaorable condition. Domain walls form between suc domains as means of minimizing the energy of the two antialigned domains. Domains walls are transitions layers in which the magnetization changes gradually from on magnetization to another.  The gradual change prevets the large increase in exchange enegery that would acoopany an abrupt change in the magnetization angle. \cite{spindomain}
