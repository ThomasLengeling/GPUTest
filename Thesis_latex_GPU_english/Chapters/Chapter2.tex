...
As said before, kernels are the essencial part of CUDA programming, threads are launched automatically throughout each thread blocks of the device. Furthermore it millions of threads execute the code.
...
As we can see NVIDIA's profiling tools is u

\vspace{3em}

Finally, this chaper gived a overview of do 
