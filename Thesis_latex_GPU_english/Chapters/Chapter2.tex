...
talk about concurencie and steam kernels.

why not use steam kernels in htis implimentations
...
As we seen kernels are executed in a sequencial form with parallel instructions. Wih CUDA's streams is possible to launche several kernels in parallel, overlap kernel in the same launch sequence. As illustrated in Figure \ref{fig:streams}.
