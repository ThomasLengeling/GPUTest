...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.55\textwidth]{Figures/ATW.png}
		\rule{35em}{0.5pt}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.55\textwidth]{Figures/VW.png}
		\rule{35em}{0.5pt}
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=0.67\textwidth]{Figures/fdtd.png}
		\rule{35em}{0.2pt}
...
In both cases, and second derivatives and fully determined provided $f^{(1)}(x_R)$ be known along the boundary. For further reference \cite{methods}. The implementation of the numerically solution in how to implement the laplacian boundaries conditions please check chapter 4.
