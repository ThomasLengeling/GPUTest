...
Trough the Profiler the kernels are invoked several times to calculate all the necessary information about how to optimze each kernel depending on several results. Also the profilers
