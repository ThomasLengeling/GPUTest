...
NVIDIA's Visual Profiler is a tool that allows collect information about different memory throughput measures. Is possible to analyze memory request inside the applications with the profiler. 
