...
\large \textit{Para obtener el T\'itulo en Licenciatura en Ingeniería en Sistemas Computacionales}\\[1.0cm] %
...
\bibliographystyle{unsrtnat} % Use the "unsrtnat" BibTeX style for formatting the Bibliography unsrt abbrv
